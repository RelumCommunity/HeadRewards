...
public class easter2 {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, easter2);
		...
		inv.setItem(10, Command.gethead("easter15"));
		inv.setItem(11, Command.gethead("easter16"));
		inv.setItem(12, Command.gethead("easter17"));
		inv.setItem(13, Command.gethead("easter18"));
		inv.setItem(14, Command.gethead("easter19"));
		inv.setItem(15, Command.gethead("easter20"));
		inv.setItem(16, Command.gethead("easter21"));
		inv.setItem(19, Command.gethead("easter22"));
		inv.setItem(20, Command.gethead("easter23"));
