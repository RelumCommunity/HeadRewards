...
public class summer2 {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, summer2);
		...
		inv.setItem(10, Command.gethead("summer15"));
		inv.setItem(11, Command.gethead("summer16"));
		inv.setItem(12, Command.gethead("summer17"));
		inv.setItem(13, Command.gethead("summer18"));
		inv.setItem(14, Command.gethead("summer19"));
		inv.setItem(15, Command.gethead("summer20"));
		inv.setItem(16, Command.gethead("summer21"));
		inv.setItem(19, Command.gethead("summer22"));
		inv.setItem(20, Command.gethead("summer23"));
		inv.setItem(21, Command.gethead("summer24"));
		inv.setItem(22, Command.gethead("summer25"));
		inv.setItem(23, Command.gethead("summer26"));
		inv.setItem(24, Command.gethead("summer27"));
