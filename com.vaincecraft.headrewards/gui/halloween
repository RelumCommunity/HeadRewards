...
public class halloween {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, halloween1);
		...
		inv.setItem(10, Command.gethead("halloween1"));
		inv.setItem(11, Command.gethead("halloween2"));
		inv.setItem(12, Command.gethead("halloween3"));
		inv.setItem(13, Command.gethead("halloween4"));
		inv.setItem(14, Command.gethead("halloween5"));
		inv.setItem(15, Command.gethead("halloween6"));
		inv.setItem(16, Command.gethead("halloween7"));
		inv.setItem(19, Command.gethead("halloween8"));
		inv.setItem(20, Command.gethead("halloween9"));
		inv.setItem(21, Command.gethead("halloween10"));
		inv.setItem(22, Command.gethead("halloween11"));
		inv.setItem(23, Command.gethead("halloween12"));
		inv.setItem(24, Command.gethead("halloween13"));
		inv.setItem(25, Command.gethead("halloween14"));
