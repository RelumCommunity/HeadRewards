...
public class summer {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, summer1);
		...
		inv.setItem(10, Command.gethead("summer1"));
		inv.setItem(11, Command.gethead("summer2"));
		inv.setItem(12, Command.gethead("summer3"));
		inv.setItem(13, Command.gethead("summer4"));
		inv.setItem(14, Command.gethead("summer5"));
		inv.setItem(15, Command.gethead("summer6"));
		inv.setItem(16, Command.gethead("summer7"));
		inv.setItem(19, Command.gethead("summer8"));
		inv.setItem(20, Command.gethead("summer9"));
		inv.setItem(21, Command.gethead("summer10"));
		inv.setItem(22, Command.gethead("summer11"));
		inv.setItem(23, Command.gethead("summer12"));
		inv.setItem(24, Command.gethead("summer13"));
		inv.setItem(25, Command.gethead("summer14"));
