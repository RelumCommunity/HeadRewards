...
public class mobegg {
	...
	public void open() {
		...
		String christmas1 =  Main.getLangFile().getString("Gui.mobegg_page_1");
		Inventory inv = Bukkit.createInventory(null, 36, christmas1);
		...
		inv.setItem(10, Command.gethead("mobegg1"));
		inv.setItem(11, Command.gethead("mobegg2"));
		inv.setItem(12, Command.gethead("mobegg3"));
		inv.setItem(13, Command.gethead("mobegg4"));
		inv.setItem(14, Command.gethead("mobegg5"));
		inv.setItem(15, Command.gethead("mobegg6"));
		inv.setItem(16, Command.gethead("mobegg7"));
		inv.setItem(19, Command.gethead("mobegg8"));
		inv.setItem(20, Command.gethead("mobegg9"));
		inv.setItem(21, Command.gethead("mobegg10"));
		inv.setItem(22, Command.gethead("mobegg11"));
		inv.setItem(23, Command.gethead("mobegg12"));
		inv.setItem(24, Command.gethead("mobegg13"));
		inv.setItem(25, Command.gethead("mobegg14"));
		inv.setItem(27, Command.gethead("testaguiback"));
