...
public class christmas {
	...
	public void open() {
		...
		inv.setItem(10, Command.gethead("christmas1"));
		inv.setItem(11, Command.gethead("christmas2"));
		inv.setItem(12, Command.gethead("christmas3"));
		inv.setItem(13, Command.gethead("christmas4"));
		inv.setItem(14, Command.gethead("christmas5"));
		inv.setItem(15, Command.gethead("christmas6"));
		inv.setItem(16, Command.gethead("christmas7"));
		inv.setItem(19, Command.gethead("christmas8"));
		inv.setItem(20, Command.gethead("christmas9"));
		inv.setItem(21, Command.gethead("christmas10"));
		inv.setItem(22, Command.gethead("christmas11"));
		inv.setItem(23, Command.gethead("christmas12"));
		inv.setItem(24, Command.gethead("christmas13"));
		inv.setItem(25, Command.gethead("christmas14"));
