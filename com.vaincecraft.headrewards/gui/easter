...
public class easter {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, easter1);
		...
		inv.setItem(10, Command.gethead("easter1"));
		inv.setItem(11, Command.gethead("easter2"));
		inv.setItem(12, Command.gethead("easter3"));
		inv.setItem(13, Command.gethead("easter4"));
		inv.setItem(14, Command.gethead("easter5"));
		inv.setItem(15, Command.gethead("easter6"));
		inv.setItem(16, Command.gethead("easter7"));
		inv.setItem(19, Command.gethead("easter8"));
		inv.setItem(20, Command.gethead("easter9"));
		inv.setItem(21, Command.gethead("easter10"));
		inv.setItem(22, Command.gethead("easter11"));
		inv.setItem(23, Command.gethead("easter12"));
		inv.setItem(24, Command.gethead("easter13"));
		inv.setItem(25, Command.gethead("easter14"));
