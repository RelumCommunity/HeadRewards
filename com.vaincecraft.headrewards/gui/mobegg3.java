...
public class mobegg3 {
	
	private Player p;
	
	public mobegg3(Player p) {
		this.p = p;
	}
	...
	public void open() {
		...
		inv.setItem(10, Command.gethead("mobegg29"));
		inv.setItem(11, Command.gethead("mobegg30"));
		inv.setItem(12, Command.gethead("mobegg31"));
		inv.setItem(13, Command.gethead("mobegg32"));
		inv.setItem(14, Command.gethead("mobegg33"));
		inv.setItem(15, Command.gethead("mobegg34"));
		inv.setItem(16, Command.gethead("mobegg35"));
		inv.setItem(19, Command.gethead("mobegg36"));
		inv.setItem(20, Command.gethead("mobegg37"));
		inv.setItem(21, Command.gethead("mobegg38"));
		inv.setItem(22, Command.gethead("mobegg39"));
		inv.setItem(23, Command.gethead("mobegg40"));
		inv.setItem(24, Command.gethead("mobegg41"));
		inv.setItem(25, Command.gethead("mobegg42"));
