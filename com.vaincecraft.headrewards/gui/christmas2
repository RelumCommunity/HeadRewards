...
public class christmas2 {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, christmas2);
		...
		inv.setItem(10, Command.gethead("christmas15"));
		inv.setItem(11, Command.gethead("christmas16"));
		inv.setItem(12, Command.gethead("christmas17"));
		inv.setItem(13, Command.gethead("christmas18"));
		inv.setItem(14, Command.gethead("christmas19"));
		inv.setItem(15, Command.gethead("christmas20"));
		inv.setItem(16, Command.gethead("christmas21"));
		inv.setItem(19, Command.gethead("christmas22"));
		inv.setItem(20, Command.gethead("christmas23"));
		inv.setItem(21, Command.gethead("christmas24"));
		inv.setItem(22, Command.gethead("christmas25"));
		inv.setItem(23, Command.gethead("christmas26"));
		inv.setItem(24, Command.gethead("christmas27"));
		inv.setItem(25, Command.gethead("christmas28"));
