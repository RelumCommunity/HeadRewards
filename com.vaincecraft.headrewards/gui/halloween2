...
public class halloween2 {
	...
	public void open() {
		...
		Inventory inv = Bukkit.createInventory(null, 36, halloween2);
		...
		inv.setItem(10, Command.gethead("halloween15"));
		inv.setItem(11, Command.gethead("halloween16"));
		inv.setItem(12, Command.gethead("halloween17"));
		inv.setItem(13, Command.gethead("halloween18"));
		inv.setItem(14, Command.gethead("halloween19"));
		inv.setItem(15, Command.gethead("halloween20"));
		inv.setItem(16, Command.gethead("halloween21"));
		inv.setItem(19, Command.gethead("halloween22"));
		inv.setItem(20, Command.gethead("halloween23"));
		inv.setItem(21, Command.gethead("halloween24"));
		inv.setItem(22, Command.gethead("halloween25"));
		inv.setItem(23, Command.gethead("halloween26"));
		inv.setItem(24, Command.gethead("halloween27"));
		inv.setItem(25, Command.gethead("halloween28"));
