...
public class mobegg4 {
	
	private Player p;
	
	public mobegg4(Player p) {
		this.p = p;
	}
	...
	public void open() {
		...
		String mobegg3 =  Main.getLangFile().getString("Gui.mobegg_page_4");
		Inventory inv = Bukkit.createInventory(null, 36, mobegg3);
		...
		inv.setItem(10, Command.gethead("mobegg43"));
		inv.setItem(11, Command.gethead("mobegg44"));
		inv.setItem(12, Command.gethead("mobegg45"));
		inv.setItem(13, Command.gethead("mobegg46"));
		inv.setItem(14, Command.gethead("mobegg47"));
		inv.setItem(15, Command.gethead("mobegg48"));
		inv.setItem(16, Command.gethead("mobegg49"));
		inv.setItem(19, Command.gethead("mobegg50"));
		inv.setItem(20, Command.gethead("mobegg51"));
		inv.setItem(21, Command.gethead("mobegg52"));
		inv.setItem(22, Command.gethead("mobegg53"));
		inv.setItem(23, Command.gethead("mobegg54"));
		inv.setItem(24, Command.gethead("mobegg55"));
		inv.setItem(25, Command.gethead("mobegg56"));
